...
pub static PREFIX_CODES: Lazy<HashSet<u8>> = Lazy::new(|| {
...
pub static USE_REG_OPCODES: Lazy<HashSet<u16>> = Lazy::new(|| {
    #[allow(clippy::deprecated_cfg_attr)]
    #[cfg_attr(rustfmt, rustfmt_skip)]
    [0x80,
        0x81,
...
pub static HAS_INLINE_REG: Lazy<HashSet<u16>> =
    Lazy::new(|| [0x50, 0x58, 0xB8].iter().cloned().collect());

pub static OPCODES: Lazy<HashMap<(u16, u8), OpCodeDef>> = Lazy::new(|| {
